...
if [ -f seeallG12V_vs_Q61H_Hras.tcl ]
then
rm -v seeallG12V_vs_Q61H_Hras.tcl
fi
...
$all move [measure fit $sel $ref]' >> seeallG12V_vs_Q61H_Hras.tcl

echo "
mol load pdb $var
mol delrep 0 top" >> seeallG12V_vs_Q61H_Hras.tcl

echo "mol representation newcartoon 0.300000 20.000000 4.100000 1
mol color ColorID 2
...
mol colupdate 0 top 0
mol scaleminmax top 0 0.000000 0.000000
mol smoothrep top 0 0" >> seeallG12V_vs_Q61H_Hras.tcl
done

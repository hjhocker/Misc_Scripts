...
if [ -f seeall_wt_kras_vs_g12v_kras.tcl ]
then
rm -v seeall_wt_kras_vs_g12v_kras.tcl
fi
...
mol delrep 0 top
" > seeall_wt_kras_vs_g12v_kras.tcl
...
$all move [measure fit $sel $ref]' >> seeall_wt_kras_vs_g12v_kras.tcl

echo "
mol load pdb $var
mol delrep 0 top" >> seeall_wt_kras_vs_g12v_kras.tcl
...
mol colupdate 0 top 0
mol scaleminmax top 0 0.000000 0.000000
mol smoothrep top 0 0" >> seeall_wt_kras_vs_g12v_kras.tcl
done
